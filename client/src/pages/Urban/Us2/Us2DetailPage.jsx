...
const Us2DetatilPage = () => {  
  ...
  useEffect(() => {
    axios.get(`${process.env.REACT_APP_API_BASE_URL}/api/major/Urban/posts/us2/${postId}`)
      .then(res => setPost(res.data))
      .catch(() => navigate('/board/us2'));
