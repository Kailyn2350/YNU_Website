...
const GraduateDetatilPage = () => {  
  ...
  useEffect(() => {
    axios.get(`${process.env.REACT_APP_API_BASE_URL}/api/major/posts/graduate/${postId}`)
      .then(res => setPost(res.data))
      .catch(() => navigate('/board/graduate'));
...
export default GraduateDetatilPage;
