...
const Es2DetatilPage = () => {  
  ...
  useEffect(() => {
    axios.get(`${process.env.REACT_APP_API_BASE_URL}/api/major/Engineering/posts/es2/${postId}`)
      .then(res => setPost(res.data))
      .catch(() => navigate('/board/es2'));
