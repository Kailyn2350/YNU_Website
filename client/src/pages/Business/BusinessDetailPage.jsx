...
const BusinessDetatilPage = () => {  
  ...
  useEffect(() => {
    axios.get(`${process.env.REACT_APP_API_BASE_URL}/api/major/posts/business/${postId}`)
      .then(res => setPost(res.data))
      .catch(() => navigate('/board/business'));
...
export default BusinessDetatilPage;
